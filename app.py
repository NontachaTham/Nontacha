                        ...
                        "contents": [
                            ...
                            },
                            {
                                ...
                                "contents": [
                                    {
                                        "type": "text",
                                        "text": str(data["temp C"]),
                                        "align": "end"
                                    },
                                    {
                                        "type": "text",
                                        "text": str(data["humidity"]),
                                        "align": "end"
                                    },
                                    {
                                        "type": "text",
                                        "text": str(data["soil moisture"]),
                                        "align": "end"
                                    },
                                    {
                                        "type": "text",
                                        "text": str(data["valvestat"]),
                                        "align": "end"
                                    },
                                    {
                                        "type": "text",
...
def valvereply():
    ...
    # https://github.com/line/line-bot-sdk-python#__init__self-channel_secret
